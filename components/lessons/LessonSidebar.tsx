    ...
    <div className="w-full lg:w-80 shrink-0">
      <div className="sticky top-24 bg-zinc-900/50 border border-zinc-800 rounded-xl overflow-hidden">
        ...
        <div className="max-h-[60vh] overflow-y-auto">
          <Accordion
            type="multiple"
            defaultValue={currentModuleId ? [String(currentModuleId)] : []}
            className="w-full"
          >
                ...
                >
                  <AccordionTrigger className="px-4 py-3 hover:no-underline hover:bg-zinc-800/50 text-left">
                    <div className="flex items-center gap-3 flex-1 min-w-0">
                      <span className="flex items-center justify-center w-6 h-6 rounded bg-white/10 text-zinc-300 text-xs font-bold shrink-0">
                        {moduleIndex + 1}
                      </span>
                        ...
                        return (
                          ...
                          >
                            {isCompleted ? (
                              ...
                              <Play className="w-4 h-4 text-zinc-300 shrink-0 fill-zinc-300" />
                            ) : (
