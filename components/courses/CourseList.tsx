          ...
          {showSearch && (
            <div className="relative w-full sm:w-72">
              ...
              <Input
                ...
                className="pl-10 bg-zinc-900/50 border-zinc-800 text-white placeholder:text-zinc-500 focus-visible:ring-zinc-500"
              />
            </div>
          )}
        </div>
        ...
        <div className="flex flex-col items-center justify-center py-16 text-center">
          ...
          {(tierFilter !== "all" || searchQuery) && (
            <button
              ...
              className="mt-2 text-sm text-zinc-400 hover:text-zinc-300 transition-colors"
            >
              Clear filters
            </button>
          )}
